...
Personal edit/retune of MakeUp shaders (9.1e)  
Mainly just fiddling with numbers here; only a few lines of new code were added.
...
- Misc. lighting & color adjustments
- New cloudmaps: 'blocky' style clouds are larger with denser coverage, 'natural' style clouds are puffier
- New color palettes: 'Vivid', 'Prairie' (default), 'Antique' 'Vanillin', 'Pinesap', & 'Outside'
