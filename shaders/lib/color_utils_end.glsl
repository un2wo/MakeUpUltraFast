...
*/
	...
	#define LIGHT_SUNSET_COLOR vec3(0.30, 0.18, 0.35)
	#define LIGHT_DAY_COLOR LIGHT_SUNSET_COLOR
	#define LIGHT_NIGHT_COLOR LIGHT_SUNSET_COLOR

	#define ZENITH_SUNSET_COLOR vec3(0.09, 0.02, 0.10)
	...
	#define LIGHT_SUNSET_COLOR vec3(0.010, 0.025, 0.017)
	#define LIGHT_DAY_COLOR LIGHT_SUNSET_COLOR
	#define LIGHT_NIGHT_COLOR LIGHT_SUNSET_COLOR

	#define ZENITH_SUNSET_COLOR vec3(0.045, 0.075, 0.060)
	#define ZENITH_DAY_COLOR ZENITH_SUNSET_COLOR
	#define ZENITH_NIGHT_COLOR ZENITH_SUNSET_COLOR
...
#elif END_SCHEME == 4  // Lunar
	#define OMNI_TINT 0.25

	#define LIGHT_SUNSET_COLOR vec3(0.30, 0.30, 0.30)
	#define LIGHT_DAY_COLOR LIGHT_SUNSET_COLOR
	#define LIGHT_NIGHT_COLOR LIGHT_SUNSET_COLOR

	#define ZENITH_SUNSET_COLOR vec3(0.0)
	#define ZENITH_DAY_COLOR ZENITH_SUNSET_COLOR
	#define ZENITH_NIGHT_COLOR ZENITH_SUNSET_COLOR
